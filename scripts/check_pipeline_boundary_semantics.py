...
# ---------------------------------------------------------------------------
CONTENT_LOCKS = {
    # Copilot port divergences are the live routing authority
    # (.claude/CLAUDE.md -> skills/ars-bootstrap/SKILL.md), host-session name,
    # and the mandatory versioned extension-bootstrap preflight. The #528
    # Stage 5/6 boundary fragments below remain byte-identical.
    "academic-pipeline/SKILL.md": "1b3ebcec0e00e1a0c41f8661d8859407062a22db40eace918670c84b1b3b4a9d",
